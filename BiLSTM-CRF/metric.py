...
def f1_score(y_true, y_pred, mode='dev'):
    ...
    fp = nb_pred - nb_correct
    fn = nb_true - nb_correct
    tn = nb_pred - fn
    logging.info("TP: {}, FP: {}, FN: {}, TN: {}".format(nb_correct, fp, fn, tn))

    p = nb_correct / nb_pred if nb_pred > 0 else 0
    r = nb_correct / nb_true if nb_true > 0 else 0
    logging.info("p: {}, r: {}".format(p, r))
    ...
    if mode == 'dev':
        ...
        for label in config.labels:
            ...
            fp_label = nb_pred_label - nb_correct_label
            fn_label = nb_true_label - nb_correct_label
            tn_label = nb_pred_label - fn_label
            logging.info("TP-label: {}, FP-label: {}, FN-label: {}, TN-label: {}".format(nb_correct_label, fp_label, fn_label, tn_label))
            ...
            logging.info("p: {}, r: {}".format(p_label, r_label))
